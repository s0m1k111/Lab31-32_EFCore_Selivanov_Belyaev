...
12. Миграции позволяют версионировать структуру базы данных, как Git для кода.
13. Code First подход удобен: изменил класс C# → создал миграцию → база автоматически обновлена.
14. SaveChangesAsync() — ключевой момент: все изменения до него существуют только в памяти.
15. async/await при работе с БД обязателен — блокировать поток на время ожидания ответа от базы нельзя.
